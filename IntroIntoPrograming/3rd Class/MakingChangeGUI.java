...
public class MakingChangeGUI{
	...
	num20=(int)change/20;
	JOptionPane.showMessageDialog(null,"The amount of 20 is: "+num20);
	change=change%20;
	
	num10=(int)change/10;
	JOptionPane.showMessageDialog(null,"The amount of 10 is: "+num10);
	change=change%10;
	
	num5=(int)change/5;
	JOptionPane.showMessageDialog(null,"The amount of 5 is: "+num5);
	change=change%5;
	
	num2=(int)change/2;
	JOptionPane.showMessageDialog(null,"The amount of 2 is: "+num2);
	change=change%2;
	
	num1=(int)change/1;
	JOptionPane.showMessageDialog(null,"The amount of 1 is: "+num1);
	change=change%1;
