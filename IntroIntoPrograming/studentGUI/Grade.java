public class Grade extends Student {
	...
	private void setSubjectGrade1(String subjectGrade1) {
	...
	private void setSubjectGrade2(String subjectGrade2) {
	...
	private void setSubjectGrade3(String subjectGrade3) {
	...
	private void setSubjectGrade4(String subjectGrade4) {
	...
	private void setSubjectGrade5(String subjectGrade5) {
	...
	public void calculateGrade() {
		...
		if (subjectMark1 < 40 || subjectMark2 < 40 || subjectMark3 < 40 || subjectMark4 < 40 || subjectMark5 < 40) {
	        overallGrade = "Fail";
        } else if (overallMark >= 80) {
			overallGrade = "Distinction";
        } else if ((overallMark >= 60) && (overallMark < 80)) {
        	overallGrade = "Credit";
        } else if ((overallMark >= 40) && (overallMark <= 59)) {
        	overallGrade = "Pass";	        
        } else {
        	overallGrade = "Fail";
        }
